...
FVector APortalUtil::TransformVectorToDestSpace(
...
FVector APortalUtil::TransformPointToDestSpace(
	const FVector& Target,
...
FQuat APortalUtil::TransformQuatToDestSpace(
	const FQuat& Target,
...
bool APortalUtil::IsPointInFrontOfPortal(const FVector& Point, const FVector& PortalPos, const FVector& PortalNormal)
{
